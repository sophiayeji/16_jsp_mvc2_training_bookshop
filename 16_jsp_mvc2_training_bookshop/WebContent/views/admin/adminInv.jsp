            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            <li><a href="adminOrderList">주문관리</a>
                            <li><a href="adminInvList">재고관리</a>
                            <li><a href="adminCustomerList">고객관리(CS)</a>                         	
                                </ul>
                            </li>
                        </ul>
                    </nav>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <span>Admin Inventory List</span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                            	...
                            	<c:forEach var="invMap" items="${invMapList }">
	                                <tr>
	                                	...
	                                	<td>${invMap.published_Dt }</td>
	                                	<td>${invMap.stock-invMap.orderBookQty}</td>
	                                </tr>
